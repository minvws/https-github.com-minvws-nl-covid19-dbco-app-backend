...
class NestedDummySchemaProvider extends EloquentBaseModel implements SchemaObject, SchemaProvider
{
    use HasSchema;
    ...
    public static function getSchema(): Schema
    {
        ...
        $schema->setDocumentationIdentifier('DummySchemaProvider.NestedDummySchemaProvider');

...
final class FadedStrategyLoaderTest extends FeatureTestCase
{
    ...
    {
        $strategyLoader = $this->app->make(FadedStrategyLoader::class);

        $this->assertInstanceOf(FadedStrategyLoader::class, $strategyLoader);
    ...
    {
        /** @var FadedStrategyLoader $strategyLoader */
        $strategyLoader = $this->app->make(FadedStrategyLoader::class);

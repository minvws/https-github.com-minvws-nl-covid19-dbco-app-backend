...
class ApiCaseCommunicationV2UpToV2ControllerTest extends FeatureTestCase
{
    public function testGet(): void
    {
        /** @var Communication $communication */
        $communication = Communication::getSchema()->getVersion(2)->newInstance();
        ...
        $case = $this->createCaseForUser($user, ['communication' => $communication, 'schema_version' => 4]);

...
#[Group('calendar')]
#[Group('validation')]
class TaskSourceCalendarValidationTest extends FeatureTestCase
{
    ...
    public function testCreateTaskValidateDateOfLastExposure(
        ...
        $case = $this->createCaseForUser($user, [
            ...
            'symptoms' => Symptoms::newInstanceWithVersion(
                2,
                static function (Symptoms $symptoms) use ($hasSymptoms): void {
            ...
            'hospital' => Hospital::newInstanceWithVersion(1, static function (Hospital $hospital) use ($isAdmitted, $reason): void {
    ...
    {
        return [
            '1: isAdmitted yes. reason covid, 2021-08-16' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                null, // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                ...
                '2021-08-16', // dateOfLastExposure
                422, // expected resultcode
            ],
            '1: isAdmitted yes. reason covid, 2021-08-17' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                null, // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                null, // eloquentCase.medication.isImmunoCompromised
            ...
            '1: isAdmitted yes. reason covid, 2021-08-18' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                null, // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                null, // eloquentCase.medication.isImmunoCompromised
                YesNoUnknown::yes(), // eloquentCase.hospital.isAdmitted
                HospitalReason::covid(), // eloquentCase.hospital.reason
                '2021-08-18', // dateOfLastExposure
                200, // expected resultcode
            ],
            '1: isAdmitted yes. reason covid, 2021-09-29' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                null, // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                null, // eloquentCase.medication.isImmunoCompromised
            ...
            '1: isAdmitted yes. reason covid, 2021-09-30' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                null, // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                null, // eloquentCase.medication.isImmunoCompromised
    ...
    {
        return [
            '2: hasSymptoms yes, hasUnderlyingSuffering no, isAdmitted no, 2021-08-16' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::no(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
            ...
            '2: hasSymptoms yes, hasUnderlyingSuffering no, isAdmitted no, 2021-08-17' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::no(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                YesNoUnknown::no(), // eloquentCase.medication.isImmunoCompromised
            ...
            '2: hasSymptoms yes, hasUnderlyingSuffering no, isAdmitted no, 2021-08-18' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::no(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                YesNoUnknown::no(), // eloquentCase.medication.isImmunoCompromised
            ...
            '2: hasSymptoms yes, hasUnderlyingSuffering no, isAdmitted no, 2021-08-29' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::no(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                YesNoUnknown::no(), // eloquentCase.medication.isImmunoCompromised
            ...
            '2: hasSymptoms yes, hasUnderlyingSuffering no, isAdmitted no, 2021-09-16' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::no(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                YesNoUnknown::no(), // eloquentCase.medication.isImmunoCompromised
    ...
    {
        return [
            '3: hasSymptoms yes, hasUnderlyingSuffering no, isAdmitted no, 2021-08-16' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::no(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                YesNoUnknown::no(), // eloquentCase.medication.isImmunoCompromised
            ...
            '3: hasSymptoms yes, hasUnderlyingSuffering no, isAdmitted no, 2021-08-17' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::no(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                YesNoUnknown::no(), // eloquentCase.medication.isImmunoCompromised
            ...
            '3: hasSymptoms yes, hasUnderlyingSuffering no, isAdmitted no, 2021-08-18' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::no(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                YesNoUnknown::no(), // eloquentCase.medication.isImmunoCompromised
            ...
            '3: hasSymptoms yes, hasUnderlyingSuffering no, isAdmitted no, 2021-08-29' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::no(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                YesNoUnknown::no(), // eloquentCase.medication.isImmunoCompromised
            ...
            '3: hasSymptoms yes, hasUnderlyingSuffering no, isAdmitted no, 2021-09-16' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::no(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                YesNoUnknown::no(), // eloquentCase.medication.isImmunoCompromised
    ...
    {
        return [
            '4: hasSymptoms yes, hasUnderlyingSuffering yes, 2021-08-16' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::yes(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
            ...
            '4: hasSymptoms yes, hasUnderlyingSuffering yes, 2021-08-17' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::yes(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                YesNoUnknown::yes(), // eloquentCase.medication.isImmunoCompromised
            ...
            '4: hasSymptoms yes, hasUnderlyingSuffering yes, 2021-08-18' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::yes(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                YesNoUnknown::yes(), // eloquentCase.medication.isImmunoCompromised
            ...
            '4: hasSymptoms yes, hasUnderlyingSuffering yes, 2021-08-29' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::yes(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                YesNoUnknown::yes(), // eloquentCase.medication.isImmunoCompromised
            ...
            '4: hasSymptoms yes, hasUnderlyingSuffering yes, 2021-08-31' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                null, // eloquentCase.immunity.isImmune
                YesNoUnknown::yes(), // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                YesNoUnknown::yes(), // eloquentCase.medication.isImmunoCompromised
    ...
    public static function calendarRulesMatrixLine5DataProvider(): array
    {
        return [
            ...
            '5: hasSymptoms yes, isImmune no, isAdmitted no, 2021-08-18' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                YesNoUnknown::no(), // eloquentCase.immunity.isImmune
                null, // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                null, // eloquentCase.medication.isImmunoCompromised
            ...
            '5: hasSymptoms yes, isImmune no, isAdmitted no, 2021-08-31' => [
                ...
                YesNoUnknown::no(), // eloquentCase.hospital.isAdmitted
                null, // eloquentCase.hospital.reason
                '2021-08-30', // dateOfLastExposure
                200, // expected resultcode
            ],
            '5: hasSymptoms yes, isImmune no, isAdmitted no, 2021-09-01' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                YesNoUnknown::no(), // eloquentCase.immunity.isImmune
                null, // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                null, // eloquentCase.medication.isImmunoCompromised
    ...
    public static function calendarRulesMatrixLine6DataProvider(): array
    {
        return [
            ...
            '6: hasSymptoms yes, isImmune yes, isAdmitted no, 2021-08-18' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                YesNoUnknown::yes(), // eloquentCase.immunity.isImmune
                null, // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                null, // eloquentCase.medication.isImmunoCompromised
            ...
            '6: hasSymptoms yes, isImmune yes, isAdmitted no, 2021-09-01' => [
                YesNoUnknown::yes(), // eloquentCase.symptoms.hasSymptoms
                YesNoUnknown::yes(), // eloquentCase.immunity.isImmune
                null, // eloquentCase.underlying_suffering.hasUnderlyingSuffering
                null, // eloquentCase.medication.isImmunoCompromised

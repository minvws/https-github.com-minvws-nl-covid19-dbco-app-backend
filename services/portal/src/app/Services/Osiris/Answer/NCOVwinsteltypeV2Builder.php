...
class NCOVwinsteltypeV2Builder extends AbstractSingleValueBuilder
{
    protected function getValue(EloquentCase $case): ?string
    {
        ...
        return match ($case->riskLocation->type) {
            ...
            RiskLocationType::prison() => '139',
            RiskLocationType::youthInstitution() => '140',
            RiskLocationType::asylumCenter() => '152',

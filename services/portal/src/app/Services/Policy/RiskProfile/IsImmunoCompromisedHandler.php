...
final class IsImmunoCompromisedHandler extends AbstractRiskProfileHandler implements RiskProfileHandler
{
    public function isApplicable(IndexPolicyFacts|ContactPolicyFacts $facts): bool
    {
        ...
        return
            $facts->hasSymptoms === YesNoUnknown::yes() &&
            $facts->isImmunoCompromised === YesNoUnknown::yes();
    }
}

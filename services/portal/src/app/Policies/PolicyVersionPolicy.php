...
class PolicyVersionPolicy
{
    ...
    public function delete(EloquentUser $eloquentUser): Response
    {
        return $this->canAccessAdminPolicyAdviceModule($eloquentUser);
    }

    public function create(EloquentUser $eloquentUser): Response
    {
        return $this->canAccessAdminPolicyAdviceModule($eloquentUser);
    }
    ...
    private function canAccessAdminPolicyAdviceModule(EloquentUser $eloquentUser): Response
    {
        return $eloquentUser->can(Permission::adminPolicyAdviceModule()->value)
            ? Response::allow()
            : Response::deny('User is not allowed to administer PolicyVersions.');
    }
}

    ...
    <LayoutSidebar useFlexSpace>
        <main class="tw-p-8">
            <header class="tw-flex tw-justify-between tw-items-start tw-mb-8">
                <Heading as="h1" size="lg" class="tw-mb-8">{{ $t('pages.conversationCoach.title') }}</Heading>
                <NavigatorInput />
            </header>
...
export default defineComponent({
    ...
    created() {
        this.setActiveRole(SupervisionRoles.CONVERSATION_COACH);
    },
    methods: {

...
class CreateKeyExchangeSecretKeyCommand extends Command
{
    ...
    {
        $result = $this->securityService->createKeyExchangeSecretKey($input->getOption('force'));
